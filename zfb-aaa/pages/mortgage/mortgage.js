...
Page({
  data: {
    ...
    // years: ['1年(12期)', '2年(24期)', '3年(36期)', '5年(60期)','10年(120期)','15年(180期)','20年(240期)','25年(300期)','30年(360期)'],
    yearIndex: 0,
  ...
  showDetail() {
    ...
    console.log(this.data.years,this.data.yearIndex);
    console.log(commercialTotal,gjjTotal,interestRatePerMou0,interestRatePerMou1,totalMouths);
    my.navigateTo({
