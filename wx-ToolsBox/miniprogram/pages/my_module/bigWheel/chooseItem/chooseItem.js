...
const imgUrl = 'https://xiaojinhe-cdn.iyoudui.cn/upload/common/2023127/adda.png'
...
Page({
  data: {
    ...
    bigWheel_close_list:imgUrl,
    bigWheel_open_list:imgUrl,
    bigWheel_add:imgUrl,
    bigWheel_edit:imgUrl,
    bigWheel_love:imgUrl,
    bigWheel_delete:imgUrl,
    bigWheel_wheel:imgUrl,
